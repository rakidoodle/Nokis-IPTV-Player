...
MyIPTV can favorite live channels, movies, and series. Choose an item in its browser and select **Add favorite**. The button changes to **Remove favorite** when the selected item is already saved. The Favorites page lists all saved items and can remove the selected entry.
